...
public class RuleLogic {
	...
	public RuleLogic() {
		...
		SetRules l = new SetRules(Card.CardAnimal.SEAL, Card.CardAnimal.SEAL, Card.CardAnimal.SEAL, Card.CardFill.CLEAN, Card.CardFill.CLEAN, Card.CardFill.CLEAN, 
				Card.CardAmount.ONE, Card.CardAmount.TWO, Card.CardAmount.THREE, Card.CardColor.BLUE, Card.CardColor.BLUE, Card.CardColor.BLUE); //Ett kort (allts� ett objekt av typen Card) skapas
		mySets.add(l);
